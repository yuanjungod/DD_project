...
class WorkflowSnapshotTests(unittest.TestCase):
    def test_workflow_template_id_from_config_prefers_template_id(self) -> None:
        config = {"workflow_template_id": "legal_compliance_due_diligence", "workflow_id": "legacy"}
        self.assertEqual(_workflow_template_id_from_config(config), "legal_compliance_due_diligence")

    def test_workflow_template_id_legacy_scope(self) -> None:
        config = {"scope": {"workflow_id": "market_entry_due_diligence"}}
        self.assertEqual(_workflow_template_id_from_config(config), "market_entry_due_diligence")
