...
- `ResourceConfig`: platform connector entries for agents — **file library** (`file_store`), **MCP** (`mcp`), or **metrics / data warehouse** (`metrics_platform`). Legacy types may still appear under the UI “other” tab until migrated.
